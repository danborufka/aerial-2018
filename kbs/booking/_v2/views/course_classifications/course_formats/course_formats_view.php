...
<head>
	...
	<link href="./css/course_format_view.css" rel="stylesheet" type="text/css" />
		...
		<div id="container">
			...
			<div class="container-overview">
				...
				<div id="button-bar">
					...
					<div id="button-new" onclick="cm.CourseFormats.new();" class="rb-button">Neu</div>
				</div>
	
				<div id="search-option-container">	
					<form class="filter-form">
						<div id="search-option-row1">
							<label for='cf_filter_name'>Kursformatname:</label>
							...
							<input type="button" onclick="cm.CourseFormats.getSearchResult(0);" id="search-button" class="rb-button" value="Suchoptionen anwenden">
						</div>
					</form>
...
<script type="text/javascript">
	$(function() {
		...
		cm.CourseFormats.getSearchResult(0);
		...
		$(".filter-form input[type='text']").on('keyup', function () {
			cm.CourseFormats.getSearchResult(400);
		}); 
