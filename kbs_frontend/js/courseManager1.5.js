...
//					jQuery('#kbs-info-date').html(d.begin + ' - ' + d.end);
    ...
    Membership: {
        initForm: function () {
            ...
            h.push('<style>#membership-form-box label { min-width: 150px } #membership-form-box input { margin-bottom: 5px; min-width: 300px; }</style>');
            h.push('<div id="membership-form-box">');
            h.push('	<h3>Anmeldung für die Mitgliedschaft</h3>');
            h.push('	<form id="form-membership">');
            h.push('		<label for="kbs-prename">Vorname*</label>');
            h.push('		<input name="prename" id="kbs-prename" required /><br>');
            h.push('		<label for="kbs-surname">Nachname*</label>');
            h.push('		<input name="surname" id="kbs-surname" required /><br>');
            h.push('		<label for="kbs-email">Email*</label>');
            h.push('		<input type="email" name="email" id="kbs-email" required /><br>');
            h.push('		<label for="kbs-phone">Telefonnummer*</label>');
            h.push('		<input name="phone" id="kbs-phone" placeholder="+43..." required /><br>');
            h.push('		<label for="kbs-birthday">Geburstdatum*</label>');
            h.push('		<input name="birthday" id="kbs-birthday" placeholder="z.B. 01.01.1990" required  /><br>');
            h.push('		<label for="kbs-street">Straße und Nummer*</label>');
            h.push('		<input name="street" id="kbs-street" placeholder="z.B. Hauptstraße 1/1" required /><br>');
            h.push('		<label for="kbs-zip">PLZ*</label>');
            h.push('		<input name="zip" id="kbs-zip" required /><br>');
            h.push('		<label for="kbs-city">Ort*</label>');
            h.push('		<input name="city" id="kbs-city" required /><br>');
            h.push('		<input type="checkbox" name="terms_accepted" id="kbs-terms-accepted" required />');
            h.push('		<label for="kbs-terms-accepted"> ' + termsLink + '</label><br>');
